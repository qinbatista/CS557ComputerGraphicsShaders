...
Display( )
{
    ...
    Pattern->SetUniformVariable( (char *)"diam",  0.2f*(float)(.5+.5*sin(0.2*M_PI*Time)) );
    Pattern->SetUniformVariable( (char *)"Ar",  0.7f+0.3f*(float)(.5+.5*sin(0.2*M_PI*Time)) );
    Pattern->SetUniformVariable( (char *)"Br",  0.3f+0.7f*(float)(.5+.5*sin(0.2*M_PI*Time)) );
    Pattern->SetUniformVariable( (char *)"uTol",  0.005f*(float)(.5+.5*sin(0.2*M_PI*Time)) );
